...
class ModelRegistry:
    ...
    def __init__(self):
        ...
        self._registry: dict[str, tuple[Type[PreTrainedModel], Type[PretrainedConfig]]] = {}
    ...
    def register_config_mapping(
        self,
        model_name: str,
        mapping_func: Callable[[DictConfig, Optional[PreTrainedTokenizerFast]], PretrainedConfig],
    ):
