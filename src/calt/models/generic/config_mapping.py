...
def create_transformer_config(
    ...
    # and batch_decode(skip_special_tokens=True) behave correctly. Otherwise the
    # config defaults (0, 1, 2) are used, which mismatch tokenizers that register
    # the special tokens at the end of the vocabulary.
