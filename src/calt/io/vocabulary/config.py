...
class VocabConfig:
    ...
    def from_config(self, config: dict | str):
        ...
        include_base_vocab = flags.get('include_base_vocab', config.get('include_base_vocab', True))
        include_base_special_tokens = flags.get('include_base_special_tokens', config.get('include_base_special_tokens', True))
