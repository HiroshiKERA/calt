...
class TestUnifiedLexer:
    ...
    def _save_test_result(self, test_name: str, input_text: str, tokens: list[str], 
                          token_text: str, config: dict):
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            ...
            f.write(f"  include_base_vocab: {config.get('include_base_vocab', 'N/A')}\n")
            f.write("\n")
    ...
    def test_example_2_separator_priority(self, vocab_config):
        ...
        self._save_test_result("example_2_separator_priority", text, tokens, token_text, config)
    ...
    def test_number_tokenization_separate(self, vocab_config):
        ...
        self._save_test_result("number_tokenization_separate", text, tokens, token_text, config)
    ...
    def test_number_tokenization_attach(self, vocab_config):
        ...
        self._save_test_result("number_tokenization_attach", text, tokens, token_text, config)
    ...
    def test_non_strict_mode_emits_unk(self, vocab_config):
        ...
        self._save_test_result("non_strict_mode_emits_unk", text, tokens, token_text, config)
    ...
    def test_very_complex_polynomial_matrix_mix(self, vocab_config):
        ...
        self._save_test_result("very_complex_polynomial_matrix_mix", text, tokens, token_text, config)
    ...
    def test_sequence_of_polynomials(self, vocab_config):
        ...
        self._save_test_result("sequence_of_polynomials", text, tokens, token_text, config)
    ...
    def test_matrix_with_nested_expressions(self, vocab_config):
        ...
        self._save_test_result("matrix_with_nested_expressions", text, tokens, token_text, config)
    ...
    def test_mixed_arithmetic_sequence(self, vocab_config):
        ...
        self._save_test_result("mixed_arithmetic_sequence", text, tokens, token_text, config)
    ...
    def test_complex_exponent_chain(self, vocab_config):
        ...
        self._save_test_result("complex_exponent_chain", text, tokens, token_text, config)
    ...
    def test_matrix_sequence_combination(self, vocab_config):
        ...
        self._save_test_result("matrix_sequence_combination", text, tokens, token_text, config)
    ...
    def test_deeply_nested_polynomial(self, vocab_config):
        ...
        self._save_test_result("deeply_nested_polynomial", text, tokens, token_text, config)
